...
# INSTALL
echo "Installing..."
time pacstrap /mnt base base-devel linux linux-firmware mkinitcpio wget gcc vi vim go pacman dhcpcd links git zsh net-tools netctl wpa_supplicant dialog terminator
