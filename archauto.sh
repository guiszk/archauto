...
# INSTALL
echo "Installing..."
time pacstrap /mnt base base-devel linux linux-firmware mkinitcpio vi vim pacman dhcpcd git zsh net-tools netctl wpa_supplicant dialog terminator firefox
